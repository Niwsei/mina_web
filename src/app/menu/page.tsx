...
export default async function MenuPage() {
  ...
  return (
    <main className="section coffee-section">
                ...
                <div className="space-y-3">
                  {signatureSuggestions.length > 0 ? (
                    signatureSuggestions.map((item) => (
                      <div
                        key={item.id}
                        className="rounded-[calc(var(--radius)-4px)] border border-white/10 bg-white/5 px-4 py-3 text-sm text-[var(--brand-cream)]/85 shadow-[0_20px_60px_-40px_rgba(0,0,0,0.85)]"
                      >
